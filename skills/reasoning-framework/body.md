...
### Interrogate the question first
...
### Map the full logical space (tetralemma)

For a claim X, examine four positions:

- **X holds** — under what conditions, with what evidence
- **¬X holds** — under what conditions, with what evidence
- **Both hold** — conditionally, in different aspects, at different scales
- **Neither holds** — X and ¬X share a flawed presupposition; the question is the wrong one
...
- What evidence would force me to abandon this conclusion?
- What am I most motivated *not* to find?
...
- What does this conclusion reinforce or erode over time?
...
- A load-bearing insight has surfaced and survived its own challenge.
- The question has dissolved into a more important one — present that instead.
- You have identified what would be needed to make progress and it isn't available — name the missing input and stop.
