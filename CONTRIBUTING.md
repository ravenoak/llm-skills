...
# edit plugins/my-skill/skill.json and plugins/my-skill/body.md
...
- Root `.claude-plugin/marketplace.json` and each `plugins/<id>/.claude-plugin/plugin.json` are regenerated and identical to the committed copies
- Security: Semgrep, npm audit, pip-audit

## Conventions

- Conventional Commits (`feat:`, `fix:`, `chore:`, `docs:`, `test:`, `refactor:`, `ci:`).
- Never edit any `.claude-plugin/*.json` by hand — they are all regenerated by `skillsmith build`.
